...
Note: The classifier lacks additional analysis of false negatives and true positives (ROC curve), which is a very important detail,
especially when it comes to medical data.
